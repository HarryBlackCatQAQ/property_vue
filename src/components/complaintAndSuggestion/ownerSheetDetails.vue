...
<template>
  <div class="ownerSheetDetails">
    <div class="btn-group">
      ...
      <el-button class="timeLine-btn" @click="showTimeLine = !showTimeLine" icon="el-icon-time">{{this.timeLineMesage}}</el-button>
    </div>
    ...
    <div class="sheet-details">
        ...
        <div class="img-group">
            ...
            <img v-for="(item,index) in this.imageList" :key="index" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1571168248685&di=db57156a9e4e9f74aa95823f99434535&imgtype=0&src=http%3A%2F%2F5b0988e595225.cdn.sohucs.com%2Fq_70%2Cc_zoom%2Cw_640%2Fimages%2F20180706%2Fda7d85175922451f942f795596e96bec.jpeg"/>
        </div>
    </div>
