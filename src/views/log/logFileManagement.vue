 ...
 * @Last Modified time: 2019-10-18 15:11:15
 */
  ...
  <div class="logFileManagement">
    ...
    <div class="log-icon">
      ...
      <div class="log-download">
          <el-button type="primary" size="medium" @click="downLoadLogFile">日志下载<i class="el-icon-download el-icon--right"></i></el-button>
      </div>
    </div>
      ...
      <el-row :gutter="160" class="row-bg" justify="start">
        <el-col v-for="(item,index) in this.fileList" :key="index" :span="2">
          ...
          >
            ...
            <li>
              <span class="log-file-text">{{item.fileName}}</span>
            </li>
          </div>
        </el-col>
      </el-row>
