 ...
 * @Last Modified time: 2020-04-07 14:26:53
 */

<template>
  <div class="dbFileDownLoadDialog">
...
export default {
  ...
  methods: {
    ...
    //   console.log("@");
      if (this.selectedList.length > 0) {
        dbFileService.downloadDbFile(this.selectedList);
  ...
  computed: mapState({
    isShowDogFileDownLoadDialog: state =>
      state.dbManagement.isShowDogFileDownLoadDialog,
    downLoadFileList: state => state.dbManagement.downLoadFileList
  }),
  watch: {
